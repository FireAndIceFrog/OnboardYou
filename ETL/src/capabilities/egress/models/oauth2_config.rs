...
use crate::domain::models::org_settings::SchemaGenerationStatus;
...
pub struct OAuth2RepoConfig {
    ...
    /// Generation run triggered by a settings change.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub schema_generation_status: Option<SchemaGenerationStatus>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub output_schema_body_path : Option<String>,

    /// Optional URL pointing to the OpenAPI spec for the output schema.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub output_schema_openapi_url: Option<String>,
}
