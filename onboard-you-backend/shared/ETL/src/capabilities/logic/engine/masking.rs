...
impl PIIMasking {
    ...
    pub fn from_action_config(config: &PIIMaskingConfig) -> Result<Self> {
...
impl ColumnCalculator for PIIMasking {
...
mod tests {
    ...
    fn test_from_action_config_new_format() {
        let cfg: PIIMaskingConfig = serde_json::from_value(serde_json::json!({
            "columns": [
